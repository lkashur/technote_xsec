...
\begin{figure}[H]
    \center
    \includegraphics[width=0.90\textwidth]{reco_pi0_mass_syst.pdf}
...
\begin{figure}[H]
    ...
    \subfloat[Transverse momentum imbalance]
        {\includegraphics[width=0.50\textwidth]{reco_dpT_syst.pdf} \label{subfig:reco_dpT_syst}} \\
    %\subfloat[Transverse opening angle]
    %    {\includegraphics[width=0.50\textwidth]{reco_dphiT_syst.pdf} \label{subfig:reco_dphiT_syst}} \\
    \subfloat[Transverse boosting angle] 
        {\includegraphics[width=0.50\textwidth]{reco_dalphaT_syst.pdf}} \label{subfig:reco_dalphaT_syst}
